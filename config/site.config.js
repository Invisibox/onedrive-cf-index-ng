...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'Ollieooon@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Invisibox',
    },
  ],
